...
Event OnInit()
	...
	SetStringValue(Self, "APPS.Framework.InfoManager.LogName", "APPS.Framework_Framework")
	StringListAdd(None, "APPS.Framework.RegisteredMods", "APPS.Framework - Framework")
